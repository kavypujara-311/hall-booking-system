...
const StatCard = ({ title, value, change, icon: Icon, delay }) => (
    ...
    >
        ...
        <div className="flex justify-between items-start mb-4 relative z-10">
            <div className="p-3 bg-black/40 rounded-2xl border border-white/5 text-luxury-blue shadow-lg group-hover:scale-110 transition-transform duration-500">
        ...
        <div className="relative z-10">
            <h3 className="text-3xl font-serif text-white font-medium mb-1">{value}</h3>
