            ...
            {isOpen && (
                <>
                    <motion.div
                        ...
                        exit={{ opacity: 0 }}
                        onClick={onClose}
                        className="fixed inset-0 bg-[#09090b]/80 backdrop-blur-md z-[60]"
                    />
                        ...
                        >
                            ...
                            <div className="flex justify-between items-center p-8 border-b border-luxury-blue/10 bg-white/[0.02] relative z-10 shrink-0">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-2xl font-serif font-bold text-white font-semibold font-medium tracking-wide">{initialData ? 'Edit Venue' : 'List New Venue'}</h3>
                                        <p className="text-xs text-luxury-beige-200 font-medium uppercase tracking-widest mt-1">Fill in the details below</p>
                                    </div>
                                </div>
                                <button
                                    onClick={onClose}
                                    className="p-2.5 hover:bg-white/10 rounded-full transition-all text-luxury-blue/60 hover:text-white font-semibold font-medium hover:rotate-90 duration-300 border border-transparent hover:border-luxury-blue/20"
                                >
                                    <X className="w-5 h-5" />
                                </button>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="p-8 space-y-8 overflow-y-auto custom-scrollbar relative z-10 flex-1">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="relative group">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                required
                                                type="text"
                                                className="w-full pl-14 pr-4 py-4 bg-zinc-800 border border-luxury-blue/10 rounded-2xl focus:ring-1 focus:ring-luxury-blue focus:border-luxury-blue outline-none text-white font-semibold font-medium placeholder-luxury-blue/20 transition-all hover:bg-white/10"
                                    ...
                                    <div className="relative group">
                                        ...
                                        <div className="relative">
                                            ...
                                            <select
                                                className="w-full pl-14 pr-4 py-4 bg-zinc-800 border border-luxury-blue/10 rounded-2xl focus:ring-1 focus:ring-luxury-blue focus:border-luxury-blue outline-none text-white font-semibold font-medium transition-all hover:bg-white/10 appearance-none"
                                                value={formData.type}
                                                onChange={e => setFormData({ ...formData, type: e.target.value })}
                                            >
                                                {venueTypes.map(t => <option key={t} value={t} className="bg-[#09090b] text-white font-semibold font-medium">{t}</option>)}
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <button type="button" onClick={addImageField} className="text-xs text-luxury-blue hover:text-white font-semibold font-medium transition-colors flex items-center gap-1 uppercase tracking-wider font-bold">
                                    ...
                                    {formData.images.map((img, index) => (
                                        <div key={index} className="flex gap-2 items-center">
                                            <div className="relative flex-1">
                                                ...
                                                <input
                                                    type="url"
                                                    className="w-full pl-14 pr-4 py-3 bg-zinc-800 border border-luxury-blue/10 rounded-xl focus:ring-1 focus:ring-luxury-blue outline-none text-white font-semibold font-medium placeholder-luxury-blue/20 text-sm"
                                ...
                                <div className="relative group">
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3 bg-zinc-800 p-4 rounded-2xl border border-luxury-blue/10">
                                        {availableAmenities.map(amenity => (
                                            <label key={amenity} className="flex items-center gap-3 cursor-pointer p-2 hover:bg-zinc-800 rounded-lg transition-colors group/item">
                                                ...
                                                />
                                                <span className={`text-sm ${formData.amenities?.includes(amenity) ? 'text-white font-semibold font-medium' : 'text-zinc-100 font-medium'}`}>{amenity}</span>
                                            </label>
                                        ))}
                                    </div>
                                </div>
                                ...
                                <div className="relative group">
                                    ...
                                    <div className="relative">
                                        ...
                                        <textarea
                                            className="w-full pl-14 pr-4 py-4 bg-zinc-800 border border-luxury-blue/10 rounded-2xl focus:ring-1 focus:ring-luxury-blue focus:border-luxury-blue outline-none text-white font-semibold font-medium placeholder-luxury-blue/20 transition-all hover:bg-white/10 min-h-[120px] resize-none"
