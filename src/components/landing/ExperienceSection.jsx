...
const ExperienceSection = () => {
    ...
    return (
        <section ref={sectionRef} className="h-screen relative overflow-hidden flex items-center justify-center border-y border-white/5 bg-black">
            {/* Parallax Background */}
            <motion.div
                style={{ scale, opacity }}
            ...
            <div className="relative z-10 text-center px-6 max-w-5xl">
                ...
                >
                    ...
                    <motion.h2
                        ...
                        className="text-6xl md:text-9xl font-royal text-white mb-8 tracking-tighter"
                    >
                        EXPERIENCE <br />
                        <span className="italic font-classic font-light text-luxury-blue">The Majestic</span>
                    </motion.h2>
                    ...
                    >
                        ...
                        <p className="text-xl md:text-3xl font-classic italic font-light text-slate-300 max-w-3xl leading-relaxed">
            ...
            <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4">
                <span className="text-[10px] font-royal tracking-[0.5em] text-white/40 uppercase">VIRTUAL TOUR</span>
