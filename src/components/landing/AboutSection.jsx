                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                    ...
                    <div className="order-2 lg:order-1">
                        ...
                        >
                            ...
                            <h2 className="text-5xl md:text-8xl font-royal text-white leading-none mb-10">
                                CURATING <br />
                                <span className="italic font-classic font-light text-luxury-blue opacity-80 pl-20">Legacies</span>
                            </h2>

                            <p className="text-xl md:text-2xl font-classic italic font-light text-slate-300 leading-relaxed mb-10">
                            ...
                            <button className="group flex items-center gap-8 py-4 px-2 border-b border-white/10 hover:border-luxury-blue transition-all duration-700">
                                <span className="text-[10px] font-royal tracking-[0.3em] text-white">DISCOVER OUR PHILOSOPHY</span>
                        ...
                        >
                            <div className="grid grid-cols-12 gap-4">
                                ...
                                <div className="col-span-7">
                                    <div className="relative overflow-hidden group border border-white/5 mt-4">
                                        <img
