            ...
            <div className="relative z-10 pt-36 pb-24 px-6 max-w-[1200px] mx-auto">
                ...
                >
                    ...
                    <h1 className="text-6xl md:text-8xl font-royal text-white mb-6 leading-none tracking-tight">
                        Terms &
                        <span className="block italic font-classic font-light text-luxury-blue/80 text-5xl md:text-7xl mt-2">Conditions</span>
                    </h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <aside className="lg:col-span-3 hidden lg:block">
                        <div className="sticky top-32 space-y-2">
                            ...
                            <div className="mt-12 p-6 rounded-3xl bg-white/[0.02] border border-white/5">
                                ...
                                <p className="text-[9px] font-royal tracking-[0.3em] text-slate-500 uppercase mb-3">Legal Inquiries</p>
                                <a href="mailto:legal@imperial.com" className="text-[10px] font-royal text-luxury-blue hover:text-white transition-colors">
                                    legal@imperial.com
                                </a>
                            </div>
                        </div>
                    ...
                    <main className="lg:col-span-9 space-y-8">
                        ...
                        >
                            <Gavel className="w-10 h-10 text-luxury-blue mx-auto mb-6 opacity-60" />
                            <p className="text-[10px] font-royal tracking-[0.4em] text-slate-500 uppercase mb-3">Questions about these terms?</p>
                            <a href="mailto:legal@imperial.com" className="text-luxury-blue font-royal tracking-[0.2em] text-sm hover:text-white transition-colors">
                                legal@imperial.com
                            </a>
