...
process.env.JWT_SECRET = process.env.JWT_SECRET || 'hall-booking-secret-123456789';
process.env.SESSION_SECRET = process.env.SESSION_SECRET || 'hall-booking-session-secret-987654321';
